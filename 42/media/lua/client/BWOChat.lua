...
table.insert(data, {query={"how", "i", "earn"}, res="Perform your job, or pick up trash from the street and such. "})
table.insert(data, {query={"how", "i", "buy"}, res="Just take items from the shop and payment will be automatic, its some new bluetooth bullshit or something. "})
...
table.insert(data, {query={"how", "i", "save", "money"}, res="Try to avoid unnecessary expenses and save what you can."})
table.insert(data, {query={"how", "i", "make", "money"}, res="There are lots of ways to make money, just keep working at it."})
table.insert(data, {query={"how", "i", "earn", "cash"}, res="You can earn cash by completing jobs or scavenging."})
table.insert(data, {query={"how", "i", "collect", "money"}, res="Collect money through various activities and tasks."})
...
table.insert(data, {query={"where", "i", "find", "job"}, res="Jobs are posted on notice boards around the city."})
table.insert(data, {query={"where", "i", "get", "paid"}, res="You get paid through various work opportunities."})
...
table.insert(data, {query={"how", "do", "i", "deposit", "money"}, res="Find a bank or ATM to deposit your money."})
table.insert(data, {query={"how", "do", "i", "withdraw", "money"}, res="You can withdraw money from an ATM or bank."})
table.insert(data, {query={"how", "do", "i", "use", "ATM"}, res="Just follow the instructions on the screen."})
...
table.insert(data, {query={"how", "i", "manage", "money"}, res="Budget wisely and track your spending."})
table.insert(data, {query={"how", "i", "invest"}, res="Look for safe investment opportunities."})
table.insert(data, {query={"where", "i", "spend", "money"}, res="Spend your money wisely on essentials."})
...
table.insert(data, {query={"do", "you", "have"}, res="Unfortunately, no.", anim="No"})
table.insert(data, {query={"have", "you", "got"}, res="I'm afraid not.", anim="No"})
table.insert(data, {query={"a", "you", "got"}, res="No, I don't.", anim="No"})
...
-- cover you eyes
table.insert(data, {query={"will", "shoot"}, res="Fuck off!", action="HOSTILE"})
table.insert(data, {query={"will", "kill"}, res="Fuck off!", action="HOSTILE"})
table.insert(data, {query={"will", "hit"}, res="Fuck off!", action="HOSTILE"})
...
table.insert(data, {query={"is", "it"}, res="Could be."})
table.insert(data, {query={"are", "they"}, res="Maybe they are."})
table.insert(data, {query={"will", "you"}, res="I might."})
table.insert(data, {query={"should", "we"}, res="We probably shouldn't."})
table.insert(data, {query={"would", "you"}, res="I might consider it."})
table.insert(data, {query={"could", "we"}, res="We could, but should we?"})
table.insert(data, {query={"did", "you"}, res="I might have."})
table.insert(data, {query={"have", "you"}, res="I might have."})
table.insert(data, {query={"is", "there"}, res="There might be."})
table.insert(data, {query={"was", "it"}, res="It could have been."})
table.insert(data, {query={"were", "you"}, res="I might have been."})
table.insert(data, {query={"do", "you", "think"}, res="I think I don't."})
table.insert(data, {query={"are", "we"}, res="We might be."})
...
table.insert(data, {query={"should", "this"}, res="It probably shouldn't."})
...
table.insert(data, {query={"what", "in", "style"}, res="Vintage and retro looks are making a comeback."})
